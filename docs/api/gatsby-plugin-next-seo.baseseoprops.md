...
[Home](./index.md) &gt; [@onserp/gatsby-plugin-next-seo](./gatsby-plugin-next-seo.md) &gt; [BaseSeoProps](./gatsby-plugin-next-seo.baseseoprops.md)
...
|  [htmlAttributes](./gatsby-plugin-next-seo.baseseoprops.htmlattributes.md) | HTMLAttributes | Allows you to add additional attributes to html tag besides language. |
...
|  [maxImagePreview](./gatsby-plugin-next-seo.baseseoprops.maximagepreview.md) | 'none' \| 'standard' \| 'large' | Sets the maximum image preview size for the search results page.  https://developers.google.com/search/docs/crawling-indexing/robots-meta-tag<!-- -->\*\*Example:\*\*<!-- -->\* \`\`\`<!-- -->jsx import React from 'react'; import { GatsbySeo } from 'gatsby-plugin-next-seo';<!-- -->export default () =<!-- -->&gt; ( &lt;<!-- -->&gt; <GatsbySeo maxImagePreview='large' /> &lt;<!-- -->/<!-- -->&gt; ); \`\`\` |
