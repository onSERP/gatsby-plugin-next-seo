...
[Home](./index.md) &gt; [@onserp/gatsby-plugin-next-seo](./gatsby-plugin-next-seo.md) &gt; [OpenGraphBook](./gatsby-plugin-next-seo.opengraphbook.md) &gt; [isbn](./gatsby-plugin-next-seo.opengraphbook.isbn.md)
